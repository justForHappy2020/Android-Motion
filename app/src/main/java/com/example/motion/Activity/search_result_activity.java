...
import com.example.motion.Fragment.search_result_fragment_artical;
import com.example.motion.Fragment.search_result_fragment_course;
import com.example.motion.Fragment.search_result_fragment_post;
import com.example.motion.Fragment.search_result_fragment_users;
...
//        });
    ...
    private void initViews() {
        tvQuit = findViewById(R.id.search_result_quit);
        ...
        etInput.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean hasFocus) {
                if(!hasFocus){
                    InputMethodManager manager = ((InputMethodManager)search_result_activity.this.getSystemService(Context.INPUT_METHOD_SERVICE));
                    if (manager != null)
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.searching_result_button:
                intent = new Intent(this, search_result_activity.class);
